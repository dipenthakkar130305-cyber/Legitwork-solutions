...
const Footer = () => {
  ...
  return (
    <footer data-testid="footer" className="bg-[#0D4C73] text-white relative grain-texture" role="contentinfo">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links Column */}
          <section aria-labelledby="footer-quicklinks-heading">
            <h3 id="footer-quicklinks-heading" className="font-heading font-bold text-lg mb-4">Quick Links</h3>
          ...
          <section aria-labelledby="footer-services-heading">
            <h3 id="footer-services-heading" className="font-heading font-bold text-lg mb-4">Our Services</h3>
            <ul className="space-y-3" role="list">
              <li>
                <Link
          ...
          <section aria-labelledby="footer-contact-heading">
            <h3 id="footer-contact-heading" className="font-heading font-bold text-lg mb-4">Contact Info</h3>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <p className="text-center text-white/60 text-sm">
            © {currentYear} LegitWork Solutions LLP. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

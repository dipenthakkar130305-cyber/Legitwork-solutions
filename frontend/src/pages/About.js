...
const About = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#F8FAFB] via-white to-[#E6F7FF] py-20" aria-labelledby="about-hero-heading">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <h1 id="about-hero-heading" className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
      ...
      {/* Company Overview */}
      <section className="py-24 bg-white" aria-labelledby="company-overview-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 id="company-overview-heading" className="font-heading font-black text-3xl lg:text-4xl tracking-tighter leading-none text-[#1A1A2E] mb-6">

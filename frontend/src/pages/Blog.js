...
const Blog = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#F8FAFB] via-white to-[#E6F7FF] py-20" aria-labelledby="blog-hero-heading">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <h1 id="blog-hero-heading" className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
      ...
      {/* Category Filter */}
      <section className="py-12 bg-white border-b border-[#0D4C73]/10" aria-labelledby="blog-categories-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 id="blog-categories-heading" className="sr-only">Filter blog posts by category</h2>
          <div className="flex flex-wrap justify-center gap-3" role="group" aria-labelledby="blog-categories-heading">

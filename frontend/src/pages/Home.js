  ...
  return (
    <>
      ...
      <div data-testid="home-page">
        {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#F8FAFB] via-white to-[#E6F7FF] py-20 lg:py-32 overflow-hidden" aria-labelledby="hero-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <h1 id="hero-heading" className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
      ...
      {/* Services Overview */}
      <section className="py-24 bg-[#F8FAFB]" aria-labelledby="services-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h2 id="services-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
      ...
      {/* Why Choose Us */}
      <section className="py-24 bg-white" aria-labelledby="why-choose-us-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 id="why-choose-us-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
              What Sets Us Apart
            </h2>
          </motion.div>
      ...
      <section className="py-24 bg-white" aria-labelledby="testimonials-heading">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <h2 id="testimonials-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
      ...
      {/* Blog Preview */}
      <section className="py-24 bg-[#F8FAFB]" aria-labelledby="blog-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div>
              ...
              <h2 id="blog-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-[#1A1A2E]">
                From Our Blog
              </h2>
            </div>
            <Link
      ...
      {/* Quick Payment Portals Section */}
      <section className="py-24 bg-gradient-to-br from-[#F8FAFB] to-white" aria-labelledby="payment-portals-heading">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 id="payment-portals-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
              Statutory Payment Portals
            </h2>
            <p className="text-[#4A5568] text-lg max-w-3xl mx-auto">
              File your statutory contributions directly through official government portals.
            </p>
          </motion.div>
      ...
      {/* CTA Banner */}
      <section className="py-24 bg-secondary relative grain-texture" aria-labelledby="cta-heading">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 id="cta-heading" className="font-heading font-black text-3xl lg:text-5xl tracking-tighter leading-none text-white mb-6">

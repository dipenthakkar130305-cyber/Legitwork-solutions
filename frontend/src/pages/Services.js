...
const Services = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#F8FAFB] via-white to-[#E6F7FF] py-20" aria-labelledby="services-hero-heading">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <h1 id="services-hero-heading" className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-none text-[#1A1A2E] mb-6">
